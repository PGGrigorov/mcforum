            ...
            <div id="sidebar" class="nav-collapse">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li><a class="" href="{{ route('category.new')}}">Create a category</a></li>
                            <li><a class="" href="{{ route('forum.new') }}">Create a forum</a></li>
                            <li><a class="" href="{{ route('ranks.new')}}">Create a rank</a></li>
                        </ul>
                    </li>
                    <li>
                    ...
                    <li>
                        <a class="" href="{{route('topic')}}">
                            <i class="fa fa-message"></i>
                            <span>Topics</span>
                        </a>
                    </li>
                    <li>
                        <a class="" href="{{route('ranks')}}">
