          ...
          <div class="row">
            <div class="col-lg-12">
              ...
              <ol class="breadcrumb">
                ...
                <li><i class="fa-solid fa-user-group"></i>Users</li>
              </ol>
            </div>
          </div>
                    ...
                    <tbody>
                        @if (count($users)> 0)
                            ...
                            <tr>
                                ...
                                @if ($user->is_admin == 1)
                                <td><a href="{{route('destroy.admin', $user->id)}}">Demote</a></td>
                                @else
                                <td><a href="{{route('make.admin', $user->id)}}">Promote</a></td>
                                @endif
                                <td><a href="{{route('user.delete', $user->id)}}" class="text-danger"><i class="fa fa-trash"></i></a></td>
