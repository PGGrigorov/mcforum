...
@section('content')
    ...
    <section id="main-content">
        <section class="wrapper">
          <div class="row">
            <div class="col-lg-12">
              <h3 class="page-header"><i class="fa fa-edit"></i>Make a new forum </h3>
              <ol class="breadcrumb">
...
<div id="edit-profile" class="tab-pane">
  <section class="panel">
    <div class="panel-body bio-graph-info">
      ...
      @endif
      <form class="form-horizontal" method="POST" action="{{ route('forum.storе')}}" enctype="multipart/form-data">
          @csrf
        ...
        {{-- Error for missing forum description --}}
        @error('desc')
        <p class="alert alert-danger">{{$message}}</p>
        @enderror
