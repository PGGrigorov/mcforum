          ...
          <div class="row">
            <div class="col-lg-12">
              ...
              <ol class="breadcrumb">
                ...
                <li><i class="fa fa-book"></i>Forums</li>
              </ol>
            </div>
          </div>
                  ...
                  <table class="table bootstrap-datatable countries">
                    ...
                    <tbody>
                        @if (count($forum)> 0)
                            ...
                            <tr>
                                <td>{{$fr->title}}</td>
                                <td>{{$fr->category->title }}</td>
                                <td>{!!$fr->desc!!}</td>
                                <td><a href="{{ route('forum',$fr->id) }}"><i class="fa fa-eye text-success"></i></a></td>
                                <td><a href="{{ route('forum.update', $fr->id)}}"><i class="fa fa-edit text-info"></i></a></td>
                                <td><a href="{{ route('forum.destroy',$fr->id)}}" class="text-danger"><i class="fa fa-trash"></i></a></td>
