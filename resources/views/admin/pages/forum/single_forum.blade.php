...
@section('content')
      ...
      <section id="main-content">
        <section class="wrapper">
          ...
          <div class="row">
            <div class="col-lg-12">
              <h3 class="page-header"><i class="fa fa-laptop"></i> Forum View</h3>
              <ol class="breadcrumb">
              ...
              <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-3">
                                <h1 style="font-weight:bold;">{{$forum->title}}</h1>
                                {{-- <img src="{{asset('storage/images/categories/'.$category->image)}}" style="width: 100px; height: 100px;" alt="Category image"> --}}
                                <h3 style="font-weight: bold;"><i>Category: {{$forum->category->title}}</i></h3>
                                <h4>{!!$forum->desc!!}</h4>
                            </div>
                        </div>
                    </div>
