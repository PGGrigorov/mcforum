...
@section('content')
    ...
    <section id="main-content">
        <section class="wrapper">
          <div class="row">
            <div class="col-lg-12">
              <h3 class="page-header"><i class="fa fa-edit"></i>Add new rank</h3>
              <ol class="breadcrumb">
                <li><i class="fa fa-home"></i><a href="/dashboard/home">Home</a></li>
                <li><i class="fa fa-ranking-star"></i>Rank</li>
...
<div id="edit-profile" class="tab-pane">
  <section class="panel">
    <div class="panel-body bio-graph-info">
      ...
      @endif
      <form class="form-horizontal" method="POST" action="{{ route('ranks.store')}}" enctype="multipart/form-data">
          @csrf
